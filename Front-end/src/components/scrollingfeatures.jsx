...
export default function ScrollingFeatures() {
  ...
  <div className="container mx-auto px-6 lg:px-20">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
      {[
        { title: "Write & Run Code", description: "Instantly execute Python code with real-time feedback.", icon: "💻" },
        { title: "Solve Real Challenges", description: "Tackle curated problems to sharpen your skills.", icon: "🧠" },
        { title: "Get Hints & Explanations", description: "Get intelligent hints and explanations to overcome challenges effortlessly.", icon: "🤖" }
      ].map((feature, index) => (
        <div key={index} className="p-6 rounded-2xl shadow-md border border-secondary flex flex-col items-center text-center">
